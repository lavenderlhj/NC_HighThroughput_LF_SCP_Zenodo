...
INPUT_FILES: List[str] = [
    ...
    str(BASE_DIR /"Input/Fig5A_LL2106_noMBR_HYE_all.csv"),  # file 1
    str(BASE_DIR /"Input/Fig5B_LL2106_noMBR_HYE_4pair_Both.csv"),  # file 1
    str(BASE_DIR /"Input/Fig5C_LL2106_Bubis_libfree_mbr_report.pg_matrix_rename.csv"),  # file 1

    # "C:/Users/llhj13/Desktop/SCP5in1_LL2106/input/LL2106_HYE250pg_DN/LL2106_noMBR_HYE_4pair_Both.csv",  # file 1
    # "C:/Users/llhj13/Desktop/SCP5in1_LL2106/input/LL2106_HYE250pg_DN/LL2106_Bubis_libfree_mbr_report.pg_matrix_rename.csv",  # file 1
    # "C:/Users/llhj13/Desktop/SCP5in1_LL2106/input/LL2106_HYE250pg_DN/LL2106_noMBR_HYE_all.csv",  # file 1

    
]

OUTPUT_DIR: str = str(BASE_DIR /"output/Fig5_HYE")
OUTPUT_PREFIX: str = "Fig5_HYE"
...
CONDITION_MAP: Dict[str, str] = {
    ...
    "150H100Y": "150H100Y", #used in this paper
    "200H50Y": "200H50Y",#used in this paper
    # "240H10Y": "240H10Y",# NOTused in this paper
...
SERIES_CONFIG: Dict[str, Dict] = {
    "Extended": {
        "files": ["Fig5A_LL2106_noMBR_HYE_all.csv",
                  
                 ],  
        "color": "#2ec289",    # example hex color
        "order": 1,
    },


    "ShortTerm": {
        "files": ["Fig5B_LL2106_noMBR_HYE_4pair_Both.csv",
                  
                  ],   
        "color": "#1a6bcf",    # example hex color
        "order": 2,
    },

 
    "Bubis": {
        "files": ["Fig5C_LL2106_Bubis_libfree_mbr_report.pg_matrix_rename.csv",
                  
                 ],   # basename of C:\users\RTK\SN.tsv
        "color": "#e3b727",    # example hex color
        "order": 3,
    },
...
FLAGS: Dict[str, bool] = {
    ...
    "run_cv_plots": True,
    "run_venn": False,  # CV modules dependent, support 3 condition ploting, and 3+ condition csv
    "run_volcano": False, # CV modules dependent
...
FILTER_CONFIG: Dict[str, float] = {
    ...
    "fc_cutoff_log2": 1.0,   # fold-change cutoff on log2 scale (e.g., 1 => 2x)
    "p_adj_cutoff": 0.05,
}
...
PCA_UMAP_PROTEIN_SET: str = "post_iqr"  #   "post_iqr" = only CV post-IQR quantifiable proteins (recommended QC view)
