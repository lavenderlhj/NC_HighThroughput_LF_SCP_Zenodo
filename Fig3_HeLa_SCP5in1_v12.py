...
INPUT_FILES: List[str] = [
    ...
    str(BASE_DIR /"input/Fig3_LL2106_QCp3_WetDry200_All_0528.csv"),  # file 4
    str(BASE_DIR /"input/Fig3_LL2106_QCp3_WetDry200_CH_0528.csv"),  # file 4
    
    
]
OUTPUT_DIR: str = str(BASE_DIR /"output/Fig3_LL2106_WetDry200_0803")
OUTPUT_PREFIX: str = "Fig3"
...
SERIES_CONFIG: Dict[str, Dict] = {
    "Fig3": {
        "files": [
                # "LL2112_GateP1_heterInput_SC.csv",
                #   "LL2112_GateP1_heterInput_ch.csv",
                #   "LL2112_NC_Experiment.csv",
                "Fig3_LL2106_QCp3_WetDry200_CH_0528.csv",
                "Fig3_LL2106_QCp3_WetDry200_All_0528.csv",
...
VENN_SERIES_CONFIG: Dict[str, Dict] = {
    "Cluster": {
        "conditions": ["cluster1", "cluster2","cluster3"],
        "colors": {
            "Cluster1": "#f78c35",  # e.g. purple
            "Cluster2": "#268DB6",  # grey
            "Cluster3": "#39DBCE",  # grey
        },
    },
    # "SN": {
    #     "conditions": ["PT", "PC", "RT"],
...
VOLCANO_COMPARISONS: List[Dict[str, Optional[str]]] = [
    ...
    {"series": "Cluster", "cond_a": "cluster2", "cond_b": "cluster1"},
    {"series": "Cluster", "cond_a": "cluster3", "cond_b": "cluster1"},
    {"series": "Cluster", "cond_a": "cluster2", "cond_b": "cluster3"},
...
FILTER_CONFIG: Dict[str, float] = {
    ...
    "fc_cutoff_log2": 1,   # fold-change cutoff on log2 scale (e.g., 1 => 2x, 0.58=1.5x)
    "p_adj_cutoff": 0.05,
}
...
CV_EXPORT_PRE_NORM_PIVOT: bool = True      # normalized pivot pre-iqr output (does NOT skip pre-IQR computation)
