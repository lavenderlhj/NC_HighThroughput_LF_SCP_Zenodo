...
INPUT_FILES: List[str] = [
    ...
    str(BASE_DIR /"Input/Fig6and7_UMAP_LL2112_NC_conc.csv"),  # file 1
  
    
    
]
OUTPUT_DIR: str = str(BASE_DIR /"output/Fig6+7/RawbyConc")
OUTPUT_PREFIX: str = "Conc"
...
SERIES_CONFIG: Dict[str, Dict] = {
    "Conc": {
        "files": [
                  "Fig6and7_UMAP_LL2112_NC_conc.csv",
...
FLAGS: Dict[str, bool] = {
    ...
    "run_pca": True, # CV modules dependent if on post-IQR, 
    "run_umap": True, # CV modules dependent if on post-IQR, 
}
...
VOLCANO_COMPARISONS: List[Dict[str, Optional[str]]] = [
    ...
    {"series": "Cluster", "cond_a": "cluster1", "cond_b": "cluster2"},
