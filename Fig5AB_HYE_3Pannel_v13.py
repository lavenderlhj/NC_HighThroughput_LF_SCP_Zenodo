...
INPUT_CSV = str(BASE_DIR / "Input/Fig5AB_HYE_LL2106_0401_input.csv")
OUTPUT_DIR = str(BASE_DIR / "output/Fig5_HYE/LL2106_3pannel")
...
PAIR_COMPARISONS = {
    "4pairs-pool": [("HYEA", "HYEB")],
    "nombr-pool": [("HYEA", "HYEB")],
